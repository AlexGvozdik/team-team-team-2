...
const refs = {
  ...
  linkLibrary: document.querySelector('.myLibrary-js'),
  inputForm: document.querySelector('.subscription__search'),
  buttonWatch: document.querySelector('.header-button_watch'),
  buttonQueue: document.querySelector('.header-button_queue'),
